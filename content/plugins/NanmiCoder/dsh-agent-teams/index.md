...
ref: "2b1141248f34ee28870d2e39462c0dbefaa5ffdb"
---
<p align="right">
  <strong>English</strong> · <a href="https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/README_ZH.md">简体中文</a>
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/NanmiCoder/dsh-agent-teams/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/assets/readme/hero.svg" width="100%" alt="dsh-agent-teams turns one DeepSeek Harness session into a coordinated multi-agent team">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/LICENSE"><img src="https://img.shields.io/npm/l/@nanmicoder/dsh-agent-teams.svg" alt="MIT license"></a>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/NanmiCoder/dsh-agent-teams/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/assets/ui.png" width="100%" alt="DeepSeek Harness conversation with the AgentTeams live activity panel, members, tasks, dependencies, and reports">
</p>
...
See [docs/usage.md](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/docs/usage.md) for the full tool reference, state model, Web UI behavior, configuration, and known limits.

## Plugin development Skill

The repository also ships the open Agent Skills package [`dsh-plugin-development`](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/skills/dsh-plugin-development/SKILL.md):
...
| Guide | Covers |
| --- | --- |
| [Usage](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/docs/usage.md) | Architecture, UI behavior, tools, configuration, limits, and validation |
| [Verification](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/docs/verification-guide.md) | Offline, composition, real e2e, and GUI verification |
| [Plugin development](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/docs/developing-dsh-plugins.md) | Human-readable guide built from this plugin |
| [README writing](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/docs/readme-writing-guide.md) | Repository documentation conventions |
...
[MIT](https://github.com/NanmiCoder/dsh-agent-teams/blob/2b1141248f34ee28870d2e39462c0dbefaa5ffdb/LICENSE)
