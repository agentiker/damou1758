...
owner: "Q00"
repo: "ouroboros"
ref: "ab5f27d76d1d7f32f86e7c8309157186cdf03f22"
---
<!-- mcp-name: io.github.Q00/ouroboros -->
<p align="right">
  <strong>English</strong> | <a href="https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/README.ko.md">한국어</a> | <a href="https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/README.zh-CN.md">简体中文</a>
</p>
...
<p align="center">
  ...
  ◯ ─────────── ◯
  <br/><br/>
  <img src="https://raw.githubusercontent.com/Q00/ouroboros/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/images/ouroboros.png" width="420" alt="Ouroboros">
  <br/><br/>
...
<p align="center">
  ...
  <a href="https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/LICENSE"><img src="https://img.shields.io/badge/license-MIT-green" alt="License"></a>
...
<table align="center">
<tr>
<td align="center" width="50%"><img src="https://raw.githubusercontent.com/Q00/ouroboros/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/images/ooo-interview.gif" width="440" alt="Terminal recording of the ouroboros CLI interview reporting an ambiguity score"><br><sub><b>Terminal CLI</b> — a task-management CLI: <code>ouroboros init start</code> asking about ordering and scope, then reporting an ambiguity score</sub></td>
<td align="center" width="50%"><img src="https://raw.githubusercontent.com/Q00/ouroboros/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/images/host-codex.gif" width="440" alt="Screen recording of the ChatGPT app calling Ouroboros as an integration"><br><sub><b>ChatGPT (Codex)</b> — called as an integration, on a video-publishing harness: the interview, its advisory lanes, and the ambiguity ledger</sub></td>
</tr>
<tr>
<td align="center" width="50%"><img src="https://raw.githubusercontent.com/Q00/ouroboros/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/images/host-claude.gif" width="440" alt="Screen recording of Claude Code running six Ouroboros interview advisory lanes in parallel"><br><sub><b>Claude Code</b> — a YouTube automation task, with the six advisory lanes running in parallel before the interview submits</sub></td>
<td align="center" width="50%"><img src="https://raw.githubusercontent.com/Q00/ouroboros/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/images/host-hermes.gif" width="440" alt="Screen recording of a Discord bot running the Ouroboros interview and reporting a final ambiguity of 0.15"><br><sub><b>Hermes (Discord)</b> — a kart-racing game, run as a chat bot, ending at <code>Final ambiguity: 0.15</code></sub></td>
</tr>
</table>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Q00/ouroboros/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/images/ooo-setup-refresh.gif" width="760" alt="Terminal recording of ouroboros setup refresh installing Codex rules and skills, Hermes skills, the OpenCode plugin and instruction guide, and the Pi and GJC bridges, ending with the line Refreshed runtime artifacts: codex, hermes, opencode, pi, gjc">
</p>
...
Core and non-LiteLLM installs support Python 3.12-3.14. LiteLLM-bearing installs (`[litellm]`, `[all]`, and source `--extra all`) support Python 3.12-3.13; use Python 3.13 for current examples. See [Platform Support](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/platform-support.md#python-profile-matrix).
...
`[all,mcp]` in one interpreter. See the [package compatibility and migration matrix](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/platform-support.md#mcp-2-and-claude-package-profiles).
...
See runtime guides: [Claude Code](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/claude-code.md) · [Codex CLI](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/codex.md) · [Hermes](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/hermes.md) · [OpenCode](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/opencode.md) · [Kiro CLI](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/kiro.md) · [Gemini CLI](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/gemini.md) · [GitHub Copilot CLI](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/copilot.md) · [Zcode](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/zcode.md) · [Pi JSON mode](https://pi.dev/docs/latest/json) · [Goose](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/goose.md) · [GJC](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/gjc.md) · [Antigravity CLI](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/antigravity.md) · [Grok Build CLI](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/runtime-guides/grok.md)
...
Removes all configuration, MCP registration, and data. See [UNINSTALL.md](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/UNINSTALL.md) for details.

</details>

> **Python >= 3.12 required.** LiteLLM-bearing profiles support Python 3.12-3.13. See [Platform Support](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/platform-support.md#python-profile-matrix) and [pyproject.toml](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/pyproject.toml).
>
...
See the [CLI reference](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/cli-reference.md) for full details.
...
See [Architecture](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/docs/architecture.md) for the full design document.
...
[Issues](https://github.com/Q00/ouroboros/issues) · [Discussions](https://github.com/Q00/ouroboros/discussions) · [Contributing Guide](https://github.com/Q00/ouroboros/blob/ab5f27d76d1d7f32f86e7c8309157186cdf03f22/CONTRIBUTING.md)
