...
ref: "b0176832cc4c485735475f0cbd210c32d58ed20b"
---
<p align="center">
  <img src="https://raw.githubusercontent.com/anywhere-labs/deepseek-harness-desktop/b0176832cc4c485735475f0cbd210c32d58ed20b/assets/desktop-hero-zh.jpg" alt="DeepSeek Harness 桌面端" width="100%">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/LICENSE"><img src="https://img.shields.io/badge/license-MIT-2EA44F?style=flat" alt="MIT License"></a>
...
<p align="center"><sub>中文 · <a href="https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/README.en.md">English</a></sub></p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/anywhere-labs/deepseek-harness-desktop/b0176832cc4c485735475f0cbd210c32d58ed20b/assets/desktop-preview.png" alt="DeepSeek Harness Desktop 界面预览" width="100%">
</p>
...
| 目标 | 入口 |
| --- | --- |
| 了解项目为什么存在 | [为什么做 DSH Desktop](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/why-desktop.md) |
| 安装和日常使用 | [用户指南](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/user-guide.md) |
| 编写普通或 Desktop 插件 | [插件开发](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/plugin-development.md) |
| 了解桌面插件可以使用的能力 | [桌面插件接口说明](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/dsh-plugin-desktop/docs/plugin-services.zh.md) |
| 了解桌面应用如何工作 | [架构说明](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/architecture.md) |
| 查看全部文档与 README 分工 | [文档索引](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/README.md) |
| 查阅包级构建与发布细节 | [`dsh-plugin-desktop/README.md`](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/dsh-plugin-desktop/README.md) |
...
Desktop 的插件能力已经可以使用。开发者可以通过两个公开接口扩展桌面端：`desktopProfiles` 用来查看和切换工作配置，`desktopPnpm` 用来在当前配置中安装、更新和移除插件。完整用法见[桌面插件接口说明](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/dsh-plugin-desktop/docs/plugin-services.zh.md)。

兼容模式尽量保持官方默认体验；高级模式则提供更完整的桌面布局和系统效果。插件市场、手机远程和 Channels 仍是后续规划，不代表当前安装包已经提供这些入口。

为什么选择这样的边界、哪些能力不会暴露给第三方插件，见[为什么做 DSH Desktop](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/why-desktop.md)和[插件开发指南](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/plugin-development.md)。
...
headless 检查使用 `corepack yarn check`；完整的构建、测试和发布边界见[架构说明](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/docs/architecture.md)和包级 [`README`](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/dsh-plugin-desktop/README.md)。
...
<table>
  ...
  <tbody>
    <tr>
      <td align="center"><img src="https://raw.githubusercontent.com/anywhere-labs/deepseek-harness-desktop/b0176832cc4c485735475f0cbd210c32d58ed20b/assets/community-wechat-group.png" alt="DeepSeek Harness Desktop 微信群二维码" width="180" height="180"></td>
      <td align="center"><img src="https://raw.githubusercontent.com/anywhere-labs/deepseek-harness-desktop/b0176832cc4c485735475f0cbd210c32d58ed20b/assets/community-qq-group.jpg" alt="DeepSeek Harness Desktop QQ群二维码" width="180" height="180"></td>
    </tr>
  </tbody>
</table>
...
本项目遵循 [MIT License](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/b0176832cc4c485735475f0cbd210c32d58ed20b/LICENSE)。
