...
ref: "3c196fffc3274bb30367a8fff77f46eff5005d2c"
---
# dsh-better-sidebar
...
<div align="center">
  🌏 <a href="https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/README.md"><b>中文</b></a> · <a href="https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/README_EN.md">English</a>
</div>
...
- **⚡ 按需加载**：启动只拉 ~325KB 核心，终端 / 编辑器等重依赖用到才按需拉取（[设计文档](https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/docs/plans/2026-08-12-lazy-chunks-design.md)）
- **🌏 多语言**：界面文案跟随 DSH 语言（zh / en）实时切换

> 🔌 **核心理念**：服务优先——内置的 7 tab + 6 viewer 与第三方插件通过同一套 `ctx.betterSidebar` API 注册，能力完全对等；官方不再内置、可由生态提供的功能，交由生态插件实现。接入文档见下方「🔌 服务化」与 [外部插件接入指南](https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/docs/external-plugin-guide.md)。
...
完整接入文档：
- **[`AGENTS.md`](https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/AGENTS.md)**——仓库内维护的接入文档（全字段、匹配算法、HMR 陷阱、声明式设置、版本探测）；
- **[`docs/external-plugin-guide.md`](https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/docs/external-plugin-guide.md)**——面向外部插件开发者的接入指南（含完整最小示例）。
...
**收录新插件**：向 [`src/client/plugins-tabs.ts`](https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/src/client/plugins-tabs.ts)（Tab 注册）或 [`src/client/plugins-viewers.ts`](https://github.com/omdsh-dev/DSH-better-sidebar/blob/3c196fffc3274bb30367a8fff77f46eff5005d2c/src/client/plugins-viewers.ts)（文件预览注册）追加一条 `PluginEntry`，并把仓库打上 `dsh-better-sidebar` topic；数据完整性由 `tests/plugin-list.spec.ts` 守护。
