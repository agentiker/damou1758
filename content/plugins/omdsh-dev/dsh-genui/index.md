...
owner: "omdsh-dev"
repo: "dsh-genui"
ref: "fd87f36a897cc25e64a4eba1bb98b1210d005fc9"
---
# 🎨 dsh-genui

<div align="center">

**English** · [简体中文](https://github.com/omdsh-dev/dsh-genui/blob/fd87f36a897cc25e64a4eba1bb98b1210d005fc9/README.zh-CN.md)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/omdsh-dev/dsh-genui/fd87f36a897cc25e64a4eba1bb98b1210d005fc9/assets/showcase-panel.png" width="92%" alt="Real rendering: an interactive monitoring panel">
  <br><em>Real output: an interactive monitoring panel rendered by the model (click "refresh" and it regenerates the data)</em>
</p>

> Player won't load? [Download the mp4](https://github.com/omdsh-dev/dsh-genui/blob/fd87f36a897cc25e64a4eba1bb98b1210d005fc9/assets/demo.mp4). Four-act demo script: [demo-prompts.md](https://github.com/omdsh-dev/dsh-genui/blob/fd87f36a897cc25e64a4eba1bb98b1210d005fc9/demo-prompts.md).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/omdsh-dev/dsh-genui/fd87f36a897cc25e64a4eba1bb98b1210d005fc9/assets/showcase-plot.png" width="60%" alt="Function plotting: drag a slider for live redraw">
</p>
...
Component JSON syntax: [SKILL.md](https://github.com/omdsh-dev/dsh-genui/blob/fd87f36a897cc25e64a4eba1bb98b1210d005fc9/SKILL.md) (also copyable to `~/.dsh/skills/genui/` to boost the model).
