...
owner: "ccch1mneyyy"
repo: "dsh-TUI"
ref: "b3baa5eb5efa0297011e82d52f1e2437b1760363"
---

<p align="center">
  <img src="https://raw.githubusercontent.com/ccch1mneyyy/dsh-TUI/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/assets/logo.svg" alt="dsh-TUI - DeepSeek Harness terminal interface" width="560">
</p>
<p align="center">
  <strong>简体中文</strong> | <a href="https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/README_EN.md">English</a>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/LICENSE"><img alt="MIT License" src="https://img.shields.io/badge/license-MIT-263146?style=flat-square"></a>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/ccch1mneyyy/dsh-TUI/b3baa5eb5efa0297011e82d52f1e2437b1760363/screenshots/wechat-official.png" alt="DeepSeek Harness 官方公众号推文收录 dsh-TUI" width="560">
</p>
...
![首屏：像素鲸鱼顶栏](https://raw.githubusercontent.com/ccch1mneyyy/dsh-TUI/b3baa5eb5efa0297011e82d52f1e2437b1760363/screenshots/splash.png)

![工作状态行 + 上下文进度条](https://raw.githubusercontent.com/ccch1mneyyy/dsh-TUI/b3baa5eb5efa0297011e82d52f1e2437b1760363/screenshots/working-line.png)
...
[在 VS Code 中运行 dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/vscode.md)。

TUI 启动后会在后台检查 npm 是否有新版本；发现更新时会提示，输入 `/update`
即可自动更新并重启恢复当前会话。

旧版 `dsh-cc-tui` / `cc-tui` profile 的迁移命令与兼容数据说明见
[安装与快速开始](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/getting-started.md#从旧包迁移)。

安装流程、profile 叠加机制、源码构建与常见问题见
[安装与快速开始](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/getting-started.md)。
...
| 主题 | 内容 |
| --- | --- |
| [安装与快速开始](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/getting-started.md) | 前置条件、安装、启动、profile 生命周期、源码开发 |
| [配置参考](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/configuration.md) | Cordis 覆盖、配置字段、Agent preset、MCP、环境变量 |
| [主题系统](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/themes.md) | 内置主题、自动检测、自定义 JSON 主题与校验规则 |
| [交互与命令](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/interaction.md) | 快捷键、鼠标、问卷、slash command 与会话工作流 |
| [架构与限制](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/architecture.md) | 运行链路、渲染与持久化设计、安全边界、已知限制 |
| [VS Code 使用指南](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/vscode.md) | 在 VS Code 集成终端运行 dsh-tui 与 companion 扩展 `dsh-tui-vscode` |
| [贡献与开发约定](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/contributing.md) | 贡献流程、仓库地图、构建产物、验证矩阵与修改规则 |
| [插件开发指南](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/plugins.md) | 插件接缝（会话事件 / 槽位 / 技能 / 主题 / prompt 段）、契约、规范与收录 |

完整的中英文索引见 [`docs/README.md`](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/README.md)。
...
- **Agent preset**：四种官方 Agent 模式（`standard` / `code` / `minimal` / `cordis`），
  ...
  详见[配置参考](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/configuration.md#agent-preset)。
- **自定义主题**：`/theme` 选择器（`auto` 跟随系统/终端背景，内置 `light` / `dark` /
  ...
  详见[主题系统](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/themes.md)。
- **MCP**：通过 `@deepseek-ai/dsh-mcp-client` 挂载服务器，工具以
  `mcp__<服务器>__<工具>` 注册；`/mcp` 查看连接状态。
  详见[配置参考](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/configuration.md#mcp)。
...
[架构文档](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/architecture.md)。
...
完整已知限制与安全边界见[架构与限制](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/architecture.md)。
...
- **插件开发指南**：[`docs/plugins.md`](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/plugins.md)（接缝、契约、规范与验证清单）
...
详见[权限边界与已知限制](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/architecture.md#权限与安全边界)。

### 友情链接

朋友们开发的[社区、相关项目与周边工具](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/docs/links.md)
...
[MIT](https://github.com/ccch1mneyyy/dsh-TUI/blob/b3baa5eb5efa0297011e82d52f1e2437b1760363/LICENSE)
