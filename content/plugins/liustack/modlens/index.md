...
owner: "liustack"
repo: "modlens"
ref: "90379748534c886b11a4df814507abb677fc8f28"
---
<p align="center">
...
<p align="center">
  <a href="https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/README.zh-CN.md">简体中文</a> ·
  <a href="https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/troubleshooting.md">Troubleshooting</a> ·
  <a href="https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/skills/modlens/references/configure.md">Configuration</a> ·
  <a href="https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/output-schema.md">Output contract</a> ·
  <a href="https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/security.md">Security</a> ·
...
<p align="center">
  ...
  <a href="https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue?style=flat-square" alt="License"></a>
...
Two knobs: `modlens config set provider <name>` states a preference (the chain still backs it up), `-p <name>` pins exactly one with no fallback. Machines behind a proxy set `HTTPS_PROXY` or `modlens config set proxy <url>` and the API providers route through it. Details: the [CLI manual](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/cli.md) for defaults and flags, [Configuration](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/skills/modlens/references/configure.md) for every key, and [Security](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/security.md) for who fetches what on remote URLs.
...
| Doc | Read it when |
| :-- | :-- |
| [Install guide](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/INSTALL.md) | Installing the skill step by step (written for an agent) |
| [CLI manual](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/cli.md) | The CLI the skill drives: flags, config, doctor |
| [Troubleshooting](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/troubleshooting.md) | A command failed and the message needs decoding |
| [Configuration](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/skills/modlens/references/configure.md) | Setting a key, switching providers, fixing config |
| [Output contract](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/output-schema.md) | Parsing the JSON or building on it |
| [Harness setup](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/harness-setup.md) | Wiring it into Codex, Claude Code, Pi, or OpenCode |
| [Security](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/docs/security.md) | File permissions, image content as untrusted input |
| [CHANGELOG](https://github.com/liustack/modlens/blob/90379748534c886b11a4df814507abb677fc8f28/CHANGELOG.md) | Finding what changed in a version |
